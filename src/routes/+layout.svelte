...
<svelte:head>
	...
	/>
	<link
		href="https://fonts.googleapis.com/css2?family=Merriweather:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap"
		rel="stylesheet"
	/>
...
<div class="site-header-wrapper">
	<header class="site-header">
		...
		<div class="site-title-block">
			...
			<div class="title-sub">how immigration shapes aapi communities</div>
		</div>
	</header>
</div>
...
<AppNav {onNav} active={activeSection} />
